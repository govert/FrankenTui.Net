...
| 5 | Widget Gallery | `widget_gallery` | `screens/widget_gallery.rs` | Core | `ShowcaseSurface.BuildWidgetGallery` | partial: local progress/list/tabs/table widget inventory gallery with frame-hit regions for all four panels plus matching mouse evidence; richer upstream gallery state, stateful mouse mutation, and exact styling remain open |
