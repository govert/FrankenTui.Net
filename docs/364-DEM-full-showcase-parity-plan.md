...
| 8 | Data Viz | `data_viz` | `screens/data_viz.rs` | Visuals | `ShowcaseSurface.BuildDataViz` | partial: local progress/metrics/narrative visualization surface with frame-hit regions for progress, metrics-table, and narrative panes plus matching mouse evidence plus mouse-mutated metric/narrative selection rendering; real upstream chart/canvas widgets and exact visualization styling remain open |
