...
| 5 | Widget Gallery | `widget_gallery` | `screens/widget_gallery.rs` | Core | `ShowcaseSurface.BuildWidgetGallery` | partial: local progress/list/tabs/table widget inventory gallery with frame-hit regions for all four panels, matching mouse evidence, and mouse-mutated list/tab/table selections; richer upstream gallery state and exact styling remain open |
