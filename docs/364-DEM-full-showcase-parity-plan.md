...
| 11 | Table Theme Gallery | `table_theme_gallery` | `screens/table_theme_gallery.rs` | Visuals | `ShowcaseSurface.BuildTableThemeGallery` | partial: local three-preset table gallery with frame-hit regions for Preset A/B/C plus matching mouse evidence; fuller upstream table-theme catalog behavior, stateful preset mutation, and exact styling remain open |
