...
| 4 | Code Explorer | `code_explorer` | `screens/code_explorer.rs` | Text | `ShowcaseSurface.BuildCodeExplorer` | partial: static code/pane approximation with frame-hit regions for tree and editor panes plus matching mouse evidence; real filesystem/code navigation, pane selection mutation, syntax styling, and exact upstream layout remain open |
