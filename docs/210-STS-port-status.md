...
- showcase hit-registry slice after upstream `f958e59e`
  ...
  selected-field rendering, the Macro Recorder increment adds mouse-mutated
  ...
  increment adds mouse-mutated tree/preview selection rendering, the Advanced
  increment adds mouse-mutated pattern/composite selection rendering, the Notifications
