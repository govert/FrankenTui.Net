...
| Runtime replay and evidence | [304-RTM-determinism-and-evidence.md](./304-RTM-determinism-and-evidence.md) | Deterministic replay and manifest artifacts are first-class, but doctor currently emits a synthetic replay entry rather than a full live-event capture. |
